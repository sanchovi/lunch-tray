...
class OrderViewModel : ViewModel() {
    ...
    fun setEntree(entree: String) {
        //set previous entree to current entree
        if (_entree.value != null){
            previousEntreePrice = _entree.value!!.price
        }

        //  subtract the previous entree price from the current
    ...
    fun setSide(side: String) {
        ...
        // subtract the previous side price from the current
        ...
        // Test the current side value to the menu item corresponding to the passed in string
    ...
    fun setAccompaniment(accompaniment: String) {
        ...
        //  subtract the previous accompaniment price from the current subtotal value. This ensures that we only charge for the currently selected
        //  accompaniment.
        if (_subtotal?.value != null){
