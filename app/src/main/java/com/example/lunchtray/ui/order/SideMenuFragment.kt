...
class SideMenuFragment : Fragment() {
    ...
    fun goToNextScreen() {
        ...
        view?.findNavController()?.navigate("action_sideMenuFragment_to_accompanimentMenuFragment")
    }
    ...
    fun cancelOrder() {
        ...
        view?.findNavController()?.navigate("action_sideMenuFragment_to_startOrderFragment")
    }
